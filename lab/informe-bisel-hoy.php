				...
				<div id="reports">
					...
					<div class="row change-page">
						  <ul class="pagination" style="font-size:10px;margin-left:20px;">
				            <li class="one active pagination"><a href="#today">Hoy</a></li>
				            <li class="two "><a href="#days-6">Ayer</a></li>
				            <li class="three"><a href="#days-5">Antier<a></li>
				            <li class="four"><a href="#days-4">Hace 3 d&iacute;as</a></li>
				            <li class="five"><a href="#days-3">Hace 4 d&iacute;as</a></li>
				            <li class="six"><a href="#days-2">Hace 5 d&iacute;as</a></li>    
				            <li class="seven"><a href="#days-2">Hace 6 d&iacute;a</a></li>
						</ul>
					</div>
				</div>
			</div>
