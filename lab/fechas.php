...
<?php
			...
			<div class="col-md-4 menu">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<ul>
							<li><a href="biseles-fecha/tratamiento.php?fecha=<?php echo $fecha; ?>&amp;w=<?php echo $w; ?>&amp;ar=<?php echo $ar; ?>&amp;foto=<?php echo $foto; ?>&amp;transitions=<?php echo $transitions; ?>&amp;crizal=<?php echo $crizal; ?>&amp;transitions_crizal=<?php echo $transitions_crizal; ?>&amp;arfoto=<?php echo $arFoto; ?>&amp;polarizado=<?php echo $polarizado; ?>&amp;polarizado_ar=<?php echo $polarizado_ar; ?>"><i class="fa fa-pie-chart" style="font-size:48px;"></i>Tratamiento</a></li>
							<li><a href="biseles-fecha/tipo.php?fecha=<?php echo $fecha; ?>&amp;terminado=<?php echo $terminado; ?>&amp;procesado=<?php echo $procesado; ?>&amp;rebisel=<?php echo $rebisel; ?>"><i class="fa fa-pie-chart" style="font-size:48px;"></i>Tipo</a></li>
