<html>
<head>
<title>Selecci&oacute;n de Pedido</title>
...
?>
        ...
        <div class="row">
            <div class="col-md-8 busqueda">
                ...
                <form onsubmit="return insertCodeF()" action="modificar-folio.php" method="post" enctype="multipart/form-data">
            ...
            <form onsubmit="return insertCodeR()" action="modificar-ref.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
