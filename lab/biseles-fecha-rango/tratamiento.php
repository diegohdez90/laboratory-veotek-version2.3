			...
			<div class="col-md-8 informes">
				...
				<div class="row change-page">
					<ul class="pagination" style="font-size:10px;margin-left:20px;">
			            ...
			            <li class="tratamiento active pagination"><a href="#">Tratamiento</a></li>
			...
			<script type="text/javascript">
				...
				function drawChart() {
					var data = google.visualization.arrayToDataTable([
						['Tratamiento', 'Total'],
						['White',<?php echo $w;?>],
						['Antirreflejante',<?php echo $ar;?>],
						['Fotocromatico',<?php echo $foto;?>],
					...
					var options = {
						title: 'Tratamiento de <?php echo $fecha; ?> al <?php echo $fecha2; ?>',
					//	pieHole: 0.4,
						pieStartAngle: 125,
					};
